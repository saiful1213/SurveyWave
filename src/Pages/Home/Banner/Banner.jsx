...
const Banner = () => {
   return (
      <div className="bg-bgImgGradient py-3 xl:h-[calc(100vh-60px)] bg-center bg-cover mt-16">
         <div className="w-full md:w-2/3 lg:w-1/2 py-12 md:py-0 px-8 flex flex-col justify-center h-full pl-3">
            ...
            <a href="#servey"><button className="btn w-40 mt-5 btn-success">Explore More</button></a>
         </div>
      </div>
   );
};
